...
CMS_SIMPLEGALLERY_TEMPLATES = getattr(settings, 'CMS_SIMPLEGALLERY_TEMPLATES', [
    ('cmsplugin_simple_gallery/fancy_image.html', 'Display first only image form gallery'),
    ('cmsplugin_simple_gallery/fancy_gallery.html', 'Display all images from gallery'),
])
